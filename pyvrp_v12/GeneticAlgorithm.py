...
if TYPE_CHECKING:
    from pyvrp_v12.PenaltyManager import PenaltyManager
    from pyvrp_v12.Population import Population
    from pyvrp_v12._pyvrp import (
        CostEvaluator,
        ProblemData,
        RandomNumberGenerator,
        Solution,
    )
    from pyvrp_v12.search.SearchMethod import SearchMethod
    from pyvrp_v12.stop.StoppingCriterion import StoppingCriterion
